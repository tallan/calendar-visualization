...
declare module powerbi.extensibility.utils.interactivity {
    ...
    */
    ...
    interface IExtensibilityMeasuredSelecionId extends ExtensibilityISelectionId {
        dataMap: SelectorsForColumn;
        measures: string[];
        getSelector(): data.Selector;
    }
    interface IMeasuredSelectionId extends ISelectionId {
        dataMap: SelectorsForColumn;
        measures: string[];
        compareMeasures(currentMeasures: string[], otherMeasures: string[]): boolean;
    }
    interface SelectorsForColumn {
        [queryName: string]: data.DataRepetitionSelector[];
    }
    function checkDatapointAgainstSelectedIds(dataPoint: SelectableDataPoint, selectedIds: ISelectionId[]): boolean;
